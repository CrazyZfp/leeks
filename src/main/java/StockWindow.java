...
import static constants.Constants.KEY_STOCK_REFRESH_INTERVAL;
...
public class StockWindow {
    ...
    public static void apply() {
        if (handler != null) {
            ...
            handler = factoryHandler();
            handler.setStriped(true);
            handler.setThreadSleepTime(pc.getInt(KEY_STOCK_REFRESH_INTERVAL, handler.getThreadSleepTime()));
